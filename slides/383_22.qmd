...
- Imagine Hero makes the same inference/perception when in Canada, also grounded in a belief that number of guns = number of people, so every Canadian has a gun.
